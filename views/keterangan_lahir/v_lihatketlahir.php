        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Lihat Surat Keterangan Lahir</h3>
            </div>    
            <!-- Card footer -->
                      ...
                      <th scope="row">
                        <div class="media align-items-center">
                          ...
                          <div class="media-body">
                            <span class="name mb-0 text-sm"><?php echo $detail->Nama_lahir ?></span>
                          </div>
                        </div>
                      </th>
                      <td class="text-right">
                        <?php echo anchor('Surat_KetLahir/cetak/' . $detail->No_surat, '<div class="btn btn-primary my-2">Cetak</div>') ?>
                        <!--<a class="mb-0 text-sm  btn btn-primary my-2" href="<?= base_url(); ?>Surat_KetLahir/cetak/ .$detail->No_surat" >Cetak</a>-->
                      </td>
                    </tr>
                  </tbody>
                </table>

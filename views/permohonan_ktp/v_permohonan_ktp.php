                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                ...
                                                <?php echo anchor('Surat_PermohonanKTP/lihat_data/' . $surat->No_surat, '<div class="dropdown-item">Lihat</div>') ?>
                                                <?php echo anchor('Surat_PermohonanKTP/sunting_data/' . $surat->No_surat, '<div class="dropdown-item">Sunting</div>') ?>
                                                <?php echo anchor('Surat_PermohonanKTP/hapus_data/' . $surat->No_surat, '<div class="dropdown-item">Hapus</div>') ?>
                                            ...
                                            <div class="modal fade bd-example-modal-sm" id="modal_hapus<?php echo $surat->No_surat; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-sm" role=document>
                                                    <div class="modal-content">
                                                        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'Surat_PermohonanKTPPermohonanKTP/hapus_data/' . $surat->No_surat ?>">

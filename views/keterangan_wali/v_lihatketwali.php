        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Lihat Surat Keterangan Wali</h3>
            </div>    
            <!-- Card footer -->
                ...
                <table class="table align-items-center table-flush">
                  <tbody class="list">
                    <tr>
                      ...
                      <td class="text-right">
                      <?php echo anchor('Surat_KetWali/cetak/' . $detail->No_surat, '<div class="btn btn-primary my-2">Cetak</div>') ?>
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <form>
                  <div class="pl-lg-2">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-walidari">Wali dari</label>
                          <input type="text" id="input-walidari" class="form-control" disabled value="<?php echo $detail->Wali_dari ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="input-keperluan" class="form-control" disabled value="<?php echo $detail->Keperluan ?>">
                        </div>
                      </div>
                    </div>
                  </div>

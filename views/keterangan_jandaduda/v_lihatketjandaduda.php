        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Lihat Surat Keterangan Janda/Duda</h3>
            </div>    
            <!-- Card footer -->
                ...
                <table class="table align-items-center table-flush">
                  <tbody class="list">
                    <tr>
                      ...
                      <td class="text-right">
                      <?php echo anchor('Surat_KetJandaDuda/cetak/' . $detail->No_surat, '<div class="btn btn-primary my-2">Cetak</div>') ?>
                      </td>
                    </tr>
                  </tbody>
                </table>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="input-statuskawin" class="form-control" disabled value="<?php echo $detail->Status_perceraian ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
